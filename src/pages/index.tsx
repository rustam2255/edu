...
import { Button, Card, Heading, Input, Tag, Text, TextArea } from '../components';
...
export const getServerSideProps: GetServerSideProps<HomeProps> = async () => {
	...
	const { data: menu } = await axios.post<MenuItem[]>(`http://localhost:3000/api/page-find`, { firstCategory });
